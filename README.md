...
# 附加方法
### 限制Napcat
screen -dmS napcat bash -c "xvfb-run -a /root/Napcat/opt/QQ/qq --no-sandbox --disable-crash-reporter --disable-logging --log-level=3 --disable-gpu --disable-features=UseOzonePlatform -q 3408240018 > /root/Napcat/output.log 2>&1"  
