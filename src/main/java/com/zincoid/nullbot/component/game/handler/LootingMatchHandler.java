package com.zincoid.nullbot.component.game.handler;

import com.mikuac.shiro.core.BotContainer;
import com.zincoid.nullbot.component.game.GameMatchHandler;
import com.zincoid.nullbot.component.game.manager.MatchManager;
import com.zincoid.nullbot.component.game.manager.PlayerManager;
import com.zincoid.nullbot.component.game.logic.LootingGameLogic;
import com.zincoid.nullbot.entity.result.GameResult;
import com.zincoid.nullbot.entity.game.basic.Match;
import com.zincoid.nullbot.entity.game.looting.LootingGameState;
import com.zincoid.nullbot.entity.game.looting.LootingPlayerState;
        ...
        for (LootingPlayerState p : state.getPlayers().values()) {
            if (p.isEvacuated()) {
                ...
                for (ItemPO item : p.getBackpack())
                    inventoryService.increase(p.getUserId(), item.getId(), 1);
            }
        }
