...
public class LootingMapFactory {
    ...
    private LootingMap lab() {
        ...
        m.getNodes().put("仓库", node("仓库", false, false, false, List.of("走廊","撤离点1")));
        m.getNodes().put("实验室", node("实验室", false, true, false, List.of("走廊","撤离点2")));
    ...
    private LootingMap factory() {
        ...
        m.getNodes().put("车间", node("车间", false, false, false, List.of("出生点A","出生点B","办公室","库房")));
        m.getNodes().put("办公室", node("办公室", false, true, false, List.of("车间","撤离点1")));
        m.getNodes().put("库房", node("库房", false, false, false, List.of("车间","撤离点2")));
